...
function be_display_posts_shortcode( $atts ) {
	...
	while ( $listing->have_posts() ): $listing->the_post(); global $post;
		...
		if ( in_category( array( 'auggie-award', 'auggie-submission', 'best-ar-campaign', 'best-ar-ent', 'best-ar-hardware', 'best-ar-sdk', 'best-ar-video', 'best-ar-etc' /*etc*/ ) )) {
        $image = '<div id="categoryvote">' . do_shortcode('[wpvoting]') . $image . '</div>';
		}
